...
class _BndBox extends State<BndBox> {
  ...
  void initState() {
    ...
    flutterTts.setSpeechRate(0.5); // Adjust as needed
    flutterTts.setPitch(1.0); // Adjust pitch if needed
    _timer = Timer.periodic(Duration(milliseconds: 800), (Timer timer) => _speak());
  }
